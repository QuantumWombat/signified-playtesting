...
class Card(Enum):
    ...
    # ARCHITECT cards
    SUMMON_RAT = ("Summon Rat", "summon a token that draws you a shiv each turn", Rarity.COMMON)
    ...
    SELF_SHARPENING_BLADE = ("Self Sharpening Blade", "deal 5 damage. deal 5 more damage next time", Rarity.UNCOMMON)

    # PYTHIA cards

    # WARRIOR cards
    BLOOD_SACRIFICE = ("Blood Sacrifice", "lose 3 HP, give a companion 2 strength", Rarity.COMMON)
    ...
    FINAL_FORM = ("Final Form", "go to 1 health. deal double dmg for rest of combat", Rarity.RARE)
